...
* An engine that can take over the whole training and testing process, with all the baby-sitting works (stage control, optimizer configuration, lr scheduling, checkpoint management, metrics & tensorboard writing, etc.) be done automatically. See our [example](https://github.com/c1aris/nncore/blob/master/examples/mnist.py) for details.
