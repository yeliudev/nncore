...
* Useful utilities
* An engine that can take over the whole training and testing process, with all the baby-sitting works (optimizer configuration, lr scheduling, checkpoint management, metrics & tensorboard writing, stage control, etc.) be done automatically.
